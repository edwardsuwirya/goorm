...
type Customer struct {
	...
	CustomerPrivileges CustomerPrivileges `gorm:"foreignKey:CustomerId;references:CustomerId"`
}
...
func (c Customer) String() string {
	return fmt.Sprintf("Id: %d, Phone: %s, Name: %s, Active Member: %v, Join Date: %v, Credential: %v, Priv: %v", c.CustomerId, c.MobilePhoneNo, c.Name, c.ActiveMember, c.JoinDate, c.UserCredential, c.CustomerPrivileges)
}
